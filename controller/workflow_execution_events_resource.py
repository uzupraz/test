...
get_workflow_stats_response_dto = api.inherit('Get Worflow Execution Events Response',server_response, {
...
class WorkflowExecutionEventsResource(Resource):
    ...
    def get(self):
        ...
        workflow_stats = self.workflow_service.get_workflow_execution_events(start_date, end_date)
